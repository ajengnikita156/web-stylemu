        ...
        <div class="mb-12 max-w-[570px] lg:mb-0">
          ...
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              ...
              <p class="text-body-color text-base">
                Jl Ters.Cibaduyut- Situ Tarate. Indonesia
              </p>
            </div>
          </div>
          <div class="mb-8 flex w-full max-w-[370px]">
          ...
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              ...
              <p class="text-body-color text-base">style@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
          <form>
            ...
            <div>
              <button
                type="submit"
                class="bg-danger border-danger w-full rounded border p-3 text-black transition hover:bg-opacity-90"
              >
                Send Message
              </button>
            </div>
