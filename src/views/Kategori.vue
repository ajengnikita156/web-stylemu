<template>
    ...
    md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
        <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg" :src="kategori.banner" alt="">
        <div class="flex flex-col justify-between p-4 leading-normal">
            <h5 class="mb-2 text-l font-bold tracking-tight text-gray-900 dark:text-white">{{ kategori.name }}</h5>
            <h5 class="mb-2 text-l font-bold tracking-tight text-gray-900 dark:text-white">{{ kategori.slug }}</h5>
