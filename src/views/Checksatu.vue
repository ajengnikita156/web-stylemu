  ...
  <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
    <div class="px-4 pt-8">
      ...
      <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
        <div class="flex flex-col rounded-lg bg-white sm:flex-row">
          <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" src="https://static.nike.com/a/images/c_limit,w_592,f_auto/t_product_v1/cc0a35b0-b3b8-427c-bf2c-334e0c4beeca/sb-logo-skate-t-shirt-LBBxZV.png" alt="" />
          <div class="flex w-full flex-col px-4 py-4">
            <span class="font-semibold">Atple</span>
            <span class="float-right text-gray-400">men's clothing</span>
            <p class="text-lg font-bold">Rp.124.500</p>
          </div>
        </div>
        <div class="flex flex-col rounded-lg bg-white sm:flex-row">
          <img class="m-2 h-24 w-28 rounded-md border object-cover object-center" src="https://static.nike.com/a/images/c_limit,w_592,f_auto/t_product_v1/cc0a35b0-b3b8-427c-bf2c-334e0c4beeca/sb-logo-skate-t-shirt-LBBxZV.png" alt="" />
          <div class="flex w-full flex-col px-4 py-4">
            <span class="font-semibold">kiwi</span>
            <span class="float-right text-gray-400">men's clothing</span>
            <p class="mt-auto text-lg font-bold">Rp.68.900</p>
          </div>
        </div>
      </div>
      ...
      <form class="mt-5 grid gap-6">
        <div class="relative">
          ...
          <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_1">
            ...
            <div class="ml-5">
              <span class="mt-2 font-semibold">Sikilat Delivery</span>
        ...
        <div class="relative">
          ...
          <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_2">
            ...
            <div class="ml-5">
              <span class="mt-2 font-semibold">Sigercep Delivery</span>
    ...
    <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
      ...
      <div class="">
        ...
        <div class="relative">
          <input type="text" id="card-holder" name="card-holder" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm uppercase shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Full Name here" />
          <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <label for="billing-address" class="mt-4 mb-2 block text-sm font-medium">Your Address</label>
        <div class="flex flex-col sm:flex-row">
          <div class="relative flex-shrink-0 sm:w-7/12">
            <input type="text" id="billing-address" name="billing-address" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Enter Your Address" />
            <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
        ...
        <div class="mt-6 border-t border-b py-2">
          <div class="flex items-center justify-between">
            ...
            <p class="font-semibold text-gray-900">Rp.193.400</p>
          </div>
          <div class="flex items-center justify-between">
        ...
        <div class="mt-6 flex items-center justify-between">
          ...
          <p class="text-2xl font-semibold text-gray-900">Rp.208.400</p>
        </div>
      </div>
      <button class="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white"><a href="/checkout">Order</a></button>
    </div>
  </div>
