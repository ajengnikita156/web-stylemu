<template>
                        ...
                        <div class="lg:flex lg:items-start">
                            <div class="lg:order-2 lg:ml-5">
                                <div class="max-w-xl overflow-hidden rounded-lg">
                                    <img class="h-full w-full max-w-full object-cover" src="https://i.pinimg.com/236x/a4/27/63/a427633b708edc49c3cec523ad110058.jpg" style="width: 530px;" alt="" />
                                </div> 
                            </div>
                            ...
                            <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
                                <div class="flex flex-row items-start lg:flex-col">
                                    <button type="button"
                                        ...
                                        <img class="h-full w-full object-cover" src="https://i.pinimg.com/236x/a4/27/63/a427633b708edc49c3cec523ad110058.jpg" alt="" />
                                    </button>
                                    <button type="button"
  ...
  export default {
    ...
    methods: {
        ...
        ...mapActions("keranjang",["addKeranjang"]),
    ...
    mounted(){
      ...
      console.log("Fetching single product with ID:", produkId);
