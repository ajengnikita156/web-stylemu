<template>
    ...
    <center>
      ...
      <p class="mb-4 text-slate-600 md:text-base sm:text-sm text-xs ">Order Code : 20230829-12273235<br><i> A copy of your order summary has been sent to {{ getUser.email}} </i></p>
